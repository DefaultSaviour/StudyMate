...
- **NEVER** push to, target, or merge into the `master` branch unless explicitly instructed to do so by the user.

# Pull Request Formatting Rules
Always format GitHub Pull Request descriptions using the following exact structure and emojis:

✨ **[Feature Name] ([relevant files])**
* [Bullet points explaining the technical implementation and design rationale]

🤖 **Agent Context (.agents/AGENTS.md)**
* [Bullet points explaining what was documented or learned]

✅ **Verification**
* [Build commands used, e.g., `assembleDebug` green]
* [Manual smoke testing steps performed]
* [Confirmation of no schema changes or new dependencies (if applicable)]
